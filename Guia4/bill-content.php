<?php 
     ...
     $arrayExploted = explode(',', $stringItems);
     $arrayItems = array();

     while(!empty($arrayExploted)) {
          $item = new Item();
          $item->setName(array_shift($arrayExploted));
          $item->setDescription(array_shift($arrayExploted));
          $item->setPrice(array_shift($arrayExploted));
          $item->setQuantity(array_shift($arrayExploted));
